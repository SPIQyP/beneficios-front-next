...
const CompanyCard = ({content}:CompanyCardProps) => {
    return (
        ...
        <div className="flex flex-col rounded-xl text-black border-2 border-gray-400 border-opacity-50 overflow-hidden min-h-[376px] shadow-lg">
            ...
            <div className="px-4 py-6">
                ...
                <p className="min-h-[48px] text-sm">{content.description}</p>
            </div>
        </div>
        </Link>
        </>
